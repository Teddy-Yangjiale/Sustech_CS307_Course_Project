...
public class DiskManager {
    ...
    public static Map<String, Integer> read_disk_manager_meta() throws DBException {
        ...
        return read_disk_manager_meta(path);
    }

    public static Map<String, Integer> read_disk_manager_meta(Path path) throws DBException {
        // read the meta file
    ...
    public void reloadMeta() throws DBException {
        this.filePages = new HashMap<>(read_disk_manager_meta(Path.of(currentDir, DISK_MANAGER_META)));
    }
